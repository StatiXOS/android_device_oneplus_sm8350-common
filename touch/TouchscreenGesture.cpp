...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {1, {KEY_GESTURE_DOWN_ARROW, "Down V", "/proc/touchpanel/down_arrow_enable"}},
    {2, {KEY_GESTURE_LEFT_ARROW, "> Symbol", "/proc/touchpanel/left_arrow_enable"}},
    {3, {KEY_GESTURE_RIGHT_ARROW, "< Symbol", "/proc/touchpanel/right_arrow_enable"}},
    ...
    {9, {KEY_GESTURE_UP_ARROW, "Up V", "/proc/touchpanel/up_arrow_enable"}},
    {10,{KEY_GESTURE_SWIPE_UP, "Up to down swipe", "/proc/touchpanel/up_swipe_enable"}},
    {11,{KEY_GESTURE_SWIPE_DOWN, "Down to up swipe", "/proc/touchpanel/down_swipe_enable"}},
    {12,{KEY_GESTURE_SWIPE_LEFT, "Left to right swipe", "/proc/touchpanel/left_swipe_enable"}},
    {13,{KEY_GESTURE_SWIPE_RIGHT, "Right to left swipe", "/proc/touchpanel/right_swipe_enable"}},
};
