...
PRODUCT_COPY_FILES += \
    ...
    $(AUDIO_HAL_DIR)/configs/lahaina/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_platform_info.xml \
...
PRODUCT_COPY_FILES += \
    frameworks/av/services/audiopolicy/config/a2dp_in_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/a2dp_in_audio_policy_configuration_7_0.xml \
    ...
    frameworks/av/services/audiopolicy/config/bluetooth_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/bluetooth_audio_policy_configuration_7_0.xml \
...
# Inherit OPlus camera
$(call inherit-product-if-exists, device/oneplus/camera/camera.mk)
